        ...
        <div className="w-full lg:w-1/2 flex justify-center items-center">
          <div className="grid grid-cols-2 gap-4 max-w-md mx-auto">
            <div className="flex flex-col gap-4">
              <div className="rounded-lg overflow-hidden shadow-lg shadow-tattoo-purple/20 animate-pulse-glow h-64 w-full">
                <img 
              ...
              <div className="rounded-lg overflow-hidden shadow-lg shadow-tattoo-purple/20 mt-auto h-64 w-full">
                <img 
            ...
            <div className="flex flex-col gap-4 mt-4">
              <div className="rounded-lg overflow-hidden shadow-lg shadow-tattoo-purple/20 h-64 w-full">
                <img 
              ...
              <div className="rounded-lg overflow-hidden shadow-lg shadow-tattoo-purple/20 animate-pulse-glow mt-auto h-64 w-full">
                <img 
